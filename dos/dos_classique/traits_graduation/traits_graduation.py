...
def generer_traits_1_degre():
    ...
    for i in range(360):
        ...
        x1 = 11.92 * math.cos(angle_rad)
        y1 = 11.92 * math.sin(angle_rad)
        x2 = 11.67 * math.cos(angle_rad)
        y2 = 11.67 * math.sin(angle_rad)
...
def generer_traits_30_degres():
    ...
    coordonnees_traits = [
    (0.000, -12.35, 0.000, -10.62),
    (6.175, -10.706, 5.306, -9.199),
    (10.706, -6.175, 9.199, -5.306),
    (12.35, 0.000, 10.62, 0.000),
    (10.706, 6.175, 9.199, 5.306),
    (6.175, 10.706, 5.306, 9.199),
    (0.000, 12.35, 0.000, 10.62),
    (-6.175, 10.706, -5.306, 9.199),
